...
// GetAWSInt32Value safely gets the value from an AWS SDK Int32 pointer
// Returns the value if pointer is not nil, or defaultValue otherwise
func GetAWSInt32Value(ptr *int32, defaultValue int32) int32 {
	if ptr == nil {
		return defaultValue
	}
	return *ptr
...
// GetAWSStringValue safely gets the value from an AWS SDK String pointer
// Returns the value if pointer is not nil, or defaultValue otherwise
func GetAWSStringValue(ptr *string, defaultValue string) string {
	if ptr == nil {
		return defaultValue
	}
	return *ptr
