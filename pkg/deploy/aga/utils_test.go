...
func TestGetAWSInt32Value(t *testing.T) {
	tests := []struct {
		name         string
		ptr          *int32
		defaultValue int32
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := GetAWSInt32Value(tt.ptr, tt.defaultValue)
			assert.Equal(t, tt.want, result)
		})
	}
}

func TestGetAWSStringValue(t *testing.T) {
	tests := []struct {
		name         string
		ptr          *string
		defaultValue string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := GetAWSStringValue(tt.ptr, tt.defaultValue)
			assert.Equal(t, tt.want, result)
		})
	}
}
